...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # Create a streamplatform manualy
    ...
    def test_streamplatform_create(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN) # because he is not the admin user
